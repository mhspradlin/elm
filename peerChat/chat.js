...
Elm.Chat.make = function (_elm) {
   ...
   var mergeUpdate = F2(function (update,
   state) {
      return function () {
         var mergeedge = F2(function (_v0,
         z) {
            return function () {
               switch (_v0.ctor)
               {case "_Tuple2":
                  return $World.updateName(_v0._0)($World.updateName(_v0._1)(A2($World.addEdge,
                    {ctor: "_Tuple2"
                    ,_0: _v0._0
                    ,_1: _v0._1},
                    z)));}
               _U.badCase($moduleName,
               "on line 444, column 33 to 80");
            }();
         });
         var theirPictureResult = $Json$Decode.decodeString($Json$Decode.list(A3($Json$Decode.tuple2,
         F2(function (v0,v1) {
            return {ctor: "_Tuple2"
                   ,_0: v0
                   ,_1: v1};
         ...
         A2($Json$Decode.at,
         _L.fromArray(["name"]),
         $Json$Decode.string)))))(update);
         var theirPicture = function () {
            switch (theirPictureResult.ctor)
            {case "Err":
               return _L.fromArray([]);
               case "Ok":
               return theirPictureResult._0;}
            _U.badCase($moduleName,
            "between lines 440 and 443");
         }();
         var newstate = _U.replace([["picture"
                                    ,A3($List.foldr,
                                    mergeedge,
                                    state.picture,
                                    theirPicture)]],
         state);
         return function () {
            var _v7 = $World.nextConnection(newstate);
            switch (_v7.ctor)
            {case "Just":
               ...
               return newstate;}
            _U.badCase($moduleName,
            "between lines 447 and 453");
         }();
      }();
   });
   var parseDisconnect = F2(function (_v9,
   state) {
      return function () {
         switch (_v9.ctor)
         {case "::": switch (_v9._1.ctor)
              {case "[]": return function () {
                      var newconnections = A2($List.filter,
                      function (x) {
                         return !_U.eq(x.id,_v9._0);
                      },
                      state.connections);
                      var self = function () {
                         var _v13 = state.self;
                      ...
                      return _U.replace([["connections"
                                        ...
                                        ,["picture"
                                         ,function () {
                                            switch (newconnections.ctor)
                                            {case "[]": return {_: {}
                                                               ,edges: _L.fromArray([])
                                                               ,nodes: _L.fromArray([self])};}
                                            return A2($World.remNode,
                                            _v9._0,
                                            state.picture);
                                         }()]
                                        ,["messages"
                                         ,A2($List._op["::"],
                                         $String.concat(_L.fromArray(["User "
                                                                     ,_v9._0
                                                                     ," disconnected"])),
                                         state.messages)]
                                        ,["queue"
              ...
              break;}
         _U.badCase($moduleName,
         "between lines 363 and 382");
      }();
   });
   var parseData = F2(function (xs,
   state) {
      return function () {
         switch (xs.ctor)
         {case "::": switch (xs._1.ctor)
              {case "::":
                 switch (xs._1._1.ctor)
                   {case "::":
                      return A2($String.startsWith,
                        "msg",
                        xs._1._1._0) ? function () {
                           var probablyduplicate = _U.eq(A2($Debug.log,
                           "content",
                           _L.fromArray([xs._1._1._0])),
                           A2($Debug.log,
                           "lastcontent",
                           $List.drop(2)(A2($String.split,
                           ":",
                           state.lastMsg))));
                           var fromid = $List.head($List.reverse(A2($String.split,
                           ",",
                           xs._1._0)));
                           return probablyduplicate ? state : _U.replace([["lastMsg"
                                                                          ,$String.join(":")(A2($List.append,
                                                                          _L.fromArray([xs._0
                                                                                       ,fromid
                                                                                       ,xs._1._1._0]),
                                                                          xs._1._1._1))]
                                                                         ,["messages"
                                                                          ...
                                                                          $String.concat(_L.fromArray(["("
                                                                                                      ,$List.head($List.reverse(A2($String.split,
                                                                                                      ",",
                                                                                                      xs._1._0)))
                                                                                                      ,") "
                                                                                                      ,function (x) {
                                                                                                      ...
                                                                                                      ":",
                                                                                                      A2($List._op["::"],
                                                                                                      $String.join(",")($List.drop(2)(A2($String.split,
                                                                                                      ",",
                                                                                                      xs._1._1._0))),
                                                                                                      xs._1._1._1))])),
                                                                          state.messages)]
                                                                         ,["queue"
                                                                          ...
                                                                          A2($String.join,
                                                                          ":",
                                                                          _L.fromArray([xs._1._0
                                                                                       ,xs._1._1._0])),
                                                                          A2($List.take,
                                                                          14,
                                                                          state.queue))]],
                           state);
                        }() : A2($String.startsWith,
                        "upd",
                        xs._1._0) ? A2(mergeUpdate,
                        A2($String.join,
                        ":",
                        A2($List._op["::"],
                        A2($String.dropLeft,3,xs._1._0),
                        A2($List._op["::"],
                        xs._1._1._0,
                        xs._1._1._1))),
                        state) : A2($String.startsWith,
                        "dis",
                        xs._1._1._0) ? function () {
                           var disconn = A2($String.dropLeft,
                           3,
                           xs._1._1._0);
                           var probablyduplicate = _U.eq(_L.fromArray([$String.concat(_L.fromArray(["User "
                                                                                                   ,disconn
                                                                                                   ," disconnected"]))]),
                           A2($List.take,
                           1,
                           state.messages));
                           return probablyduplicate ? state : _U.replace([["picture"
                                                                          ,A2($World.remNode,
                                                                          disconn,
                                                                          state.picture)]
                                                                         ,["messages"
            ...
            case "[]": return state;}
         _U.badCase($moduleName,
         "between lines 253 and 333");
      }();
   });
   var forward = function (state) {
      return function () {
         var _v23 = state.queue;
         switch (_v23.ctor)
         {case "::": return function () {
                 var _v26 = A2($String.split,
                 ":",
                 _v23._0);
                 switch (_v26.ctor)
                 {case "::": switch (_v26._0)
                      {case "connect":
                         switch (_v26._1.ctor)
                           {case "::":
                              switch (_v26._1._1.ctor)
                                {case "[]": return _v23._0;}
                                break;}
                           break;
                         case "send":
                         switch (_v26._1.ctor)
                           {case "::": switch (_v26._1._0)
                                {case "all": return _v23._0;}
                                break;}
                           break;}
                      switch (_v26._1.ctor)
                      {case "::": return function () {
                              var past = A2($String.split,
                              ",",
                              _v26._0);
                              var future = A2($List.filter,
                              function (x) {
                                 return A2($List.all,
                                 F2(function (x,y) {
                                    return !_U.eq(x,y);
                              ...
                              future));
                              var futureTrace = $String.concat(_L.fromArray([futureList
                                                                            ,","
                                                                            ,_v26._0]));
                              return function () {
                                 switch (future.ctor)
   ...
   var makeString = function (_v36) {
      return function () {
         switch (_v36.ctor)
         {case "_Tuple2":
            return $String.concat(_L.fromArray(["[{"
                                               ,"\"id\":\""
                                               ,_v36._0.id
                                               ,"\",\"name\":\""
                                               ,_v36._0.name
                                               ...
                                               ,"\"}]"]));}
         _U.badCase($moduleName,
         "between lines 147 and 158");
      }();
   };
   var syncExisting = F2(function (xs,
   state) {
      return function () {
         switch (xs.ctor)
         {case "::": switch (xs._1.ctor)
              {case "[]": return function () {
                      var existingNodes = function () {
                      ...
                      state.picture.nodes);
                      var extraNodeIDs = A2($List.map,
                      function (x) {
                         return x.id;
                      },
                      extraNodes);
                      var newPicture = function () {
                         switch (extraNodeIDs.ctor)
                         {case "[]":
                      ...
                      var sendUpdate = $String.concat(_L.fromArray(["send:all:upd"
                                                                   ,"["
                                                                   ,A2($String.join,
                                                                   ",",
                                                                   A2($List.map,
   ...
   var timeUpdate = function (_v47) {
      return function () {
         switch (_v47.ctor)
         {case "_Tuple2":
            return function () {
                 var _v51 = _v47._1.self;
                 switch (_v51.ctor)
                 {case "Just":
                    return function () {
                         var _v53 = _v47._1.connections;
                         switch (_v53.ctor)
                         {case "[]":
                            return _U.eq(A2($Basics._op["%"],
                              $Basics.round($Time.inSeconds(_v47._0)),
                              3),
                              0) ? "connectToExisting" : "noOp";}
                         return "getExisting";
                      }();
                    case "Nothing":
                    return function () {
                         var _v54 = _v47._1.connecting;
                         switch (_v54)
                         {case false:
                            return function () {
                                 var tryID = A2($Basics._op["%"],
                                 $Basics.round($Time.inSeconds(_v47._0)),
                                 100);
                                 return A2($String.append,
                                 "makePeer:",
                                 $Basics.toString(tryID));
                              }();
                            case true: return "noOp";}
                         _U.badCase($moduleName,
                         "between lines 133 and 138");
                      }();}
                 _U.badCase($moduleName,
                 "between lines 132 and 143");
              }();}
         _U.badCase($moduleName,
         "between lines 132 and 143");
      }();
   };
   var splitOnce = F3(function (delim,
   str,
   accum) {
      return function () {
         var _v55 = $String.uncons(str);
         switch (_v55.ctor)
         {case "Just":
            switch (_v55._0.ctor)
              {case "_Tuple2":
                 return _U.eq($String.fromChar(_v55._0._0),
                   delim) ? _L.fromArray([accum
                                         ,_v55._0._1]) : A3(splitOnce,
                   delim,
                   _v55._0._1,
                   A2($String.append,
                   _v55._0._1,
                   $String.fromChar(_v55._0._0)));}
              break;
            case "Nothing":
            return _L.fromArray([]);}
         _U.badCase($moduleName,
   ...
   var fromJust = function (_v59) {
      return function () {
         switch (_v59.ctor)
         {case "Just": return _v59._0;}
         _U.badCase($moduleName,
         "on line 86, column 21 to 22");
      }();
   };
   var parseMsg = F2(function (msg,
   instate) {
      return function () {
         var clearFluff = _U.eq(msg,
         "clearQueue") ? _L.fromArray([]) : _L.fromArray([msg]);
         var state = _U.replace([["sysMessages"
                                 ,$List.append(clearFluff)(A2($List.take,
                                 10,
                                 instate.sysMessages))]],
         instate);
         return function () {
            var _v62 = A2($String.split,
            ":",
            msg);
            switch (_v62.ctor)
            {case "::": switch (_v62._0)
                 {case "attemptingServerConn":
                    return _U.replace([["connecting"
                                       ,true]],
                      state);
                    case "clearQueue":
                    return _U.replace([["queue"
                                       ,A2($List.drop,1,state.queue)]],
                      state);
                    case "connectedTo":
                    return function () {
                         var self = fromJust(state.self);
                         var newConn = {_: {}
                                       ,id: $List.head(_v62._1)
                                       ,name: "unassigned"};
                         var newstate = _U.replace([["connections"
                                                    ,A2($List._op["::"],
                                                    newConn,
                                                    state.connections)]
                                                   ,["picture"
                    ...
                    return A2(parseDisconnect,
                      _v62._1,
                      state);
                    case "err": return state;
                    case "existing":
                    return A2(syncExisting,
                      _v62._1,
                      state);
                    case "lostConn":
                    return _U.replace([["connecting"
   ...
   state) {
      return function () {
         switch (event.ctor)
         {case "BoxUpdate":
            return _U.replace([["textBox"
                               ,event._0]],
              state);
            case "Cmd": return A2(parseMsg,
              event._0,
              state);
            case "Enter": switch (event._0)
   ...
   var visualizeWorld = F2(function (_v69,
   state) {
      return function () {
         switch (_v69.ctor)
         {case "_Tuple2":
            return function () {
                 var circleColor = function (x) {
                    return _U.eq(state.self,
                    $Maybe.Nothing) ? $Color.lightBlue : _U.eq(x.id,
                    function (y) {
                       return y.id;
                    }(fromJust(state.self))) ? $Color.lightRed : $Color.lightBlue;
                 };
                 var defaultStyle = $Text.defaultStyle;
                 var idStyle = _U.replace([["height"
                                           ,$Maybe.Just(14)]
                                          ,["bold",true]
                                          ,["color",$Color.white]],
                 defaultStyle);
                 var circle = function (x) {
                    return $Graphics$Collage.group(_L.fromArray([$Graphics$Collage.filled(circleColor(x))($Graphics$Collage.circle(20))
                                                                ,$Graphics$Collage.toForm($Text.leftAligned($Text.style(idStyle)($Text.fromString(x.id))))]));
                 };
                 var myMin = F2(function (x,y) {
                    return _U.cmp(x,
                    y) < 0 ? x : y;
                 });
                 var radius = (A2(myMin,
                 _v69._0,
                 _v69._1) / 2 | 0) - 20;
                 var world = state.picture;
                 var indexedNodes = A2($List.indexedMap,
                 F2(function (v0,v1) {
                    return {ctor: "_Tuple2"
                           ,_0: v0
                           ,_1: v1};
                 ...
                 world.nodes);
                 var steps = $List.length(world.nodes);
                 var thetaN = function (x) {
                    return 2 * $Basics.pi * $Basics.toFloat(x) / $Basics.toFloat(steps);
                 };
                 var xTheta = function (i) {
                    return $Basics.toFloat(radius) * $Basics.cos(thetaN(i));
                 };
                 var yTheta = function (i) {
                    return $Basics.toFloat(radius) * $Basics.sin(thetaN(i));
                 };
                 var placeNode = function (_v73) {
                    return function () {
                       switch (_v73.ctor)
                       {case "_Tuple2":
                          return $Graphics$Collage.move({ctor: "_Tuple2"
                                                        ,_0: xTheta(_v73._0)
                                                        ,_1: yTheta(_v73._0)})(circle(_v73._1));}
                       _U.badCase($moduleName,
                       "between lines 481 and 482");
                    }();
                 };
                 var nodes = A2($List.map,
                 placeNode,
                 indexedNodes);
                 var getNodePos = function (x) {
                    ...
                    function (_v77) {
                       return function () {
                          switch (_v77.ctor)
                          {case "_Tuple2":
                             return _U.eq(_v77._1.id,x.id);}
                          _U.badCase($moduleName,
                          "on line 486, column 55 to 67");
                       }();
                    },
                    indexedNodes)));
                 };
                 var makeEdge = function (_v85) {
                    return function () {
                       switch (_v85.ctor)
                       {case "_Tuple2":
         ...
         _U.badCase($moduleName,
         "between lines 458 and 491");
      }();
   });
   var fromElmChannel = $Signal.channel("");
   var fromJS = _P.portIn("fromJS",
   _P.incomingSignal(function (v) {
      return typeof v === "string" || typeof v === "object" && v instanceof String ? v : _U.badPort("a string",
      v);
   }));
   var noContent = $Graphics$Input$Field.noContent;
   var boxChannel = $Signal.channel($Graphics$Input$Field.noContent);
   var buttonChannel = $Signal.channel("");
   var commands = _L.fromArray(["makePeer"
                               ,"myID"
                               ,"connect"
                               ,"send"
                               ,"listConns"
                               ...
                               ,"connectToExisting"
                               ,"getExisting"]);
   var parseInput = F3(function (instr,
   state,
   salt) {
      return A2($List.any,
      function (x) {
      ...
      commands) ? instr : function () {
         var msgID = $Basics.fst(A2($Random.generate,
         A2($Random.$int,1,999999),
         $Random.initialSeed(salt)));
         var content = A2($String.join,
         ",",
         _L.fromArray(["msg"
                      ,$Basics.toString(msgID)
                      ,instr]));
         var recipients = $String.join(",")(A2($List.map,
         function (x) {
            return x.id;
         },
         state.connections));
         ...
         var trace = $String.join(",")(A2($List.map,
         function (x) {
            return x.id;
         },
         A2($List.append,
   ...
   _v91) {
      return function () {
         ...
         {case "_Tuple2":
            return function () {
                 var connectionText = A2($List.map,
                 $Basics.toString,
                 state.connections);
                 var selfText = function () {
                    var _v95 = state.self;
                    switch (_v95.ctor)
                    {case "Just":
                       return $String.concat(_L.fromArray(["    ID: "
                                                          ,_v95._0.id
                                                          ,$String.fromChar(_U.chr("\n"))
                                                          ,"    Name: "
                                                          ,_v95._0.name]));
                       case "Nothing":
                       return "Have not obtained ID yet!";}
                    _U.badCase($moduleName,
                    "between lines 546 and 553");
                 }();
                 var styleMap = function (style) {
                    return $List.map(function ($) {
                       return $Text.leftAligned($Text.style(style)($Text.fromString($)));
                    });
                 };
                 var fontfaces = _L.fromArray(["Verdana"
                                              ,"Geneva"
                                              ,"sans-serif"]);
                 var textDefaultStyle = $Text.defaultStyle;
                 var messageStyle = _U.replace([["typeface"
                                                ,fontfaces]],
                 textDefaultStyle);
                 var headerStyle = _U.replace([["height"
                                              ...
                                              ,["bold",true]],
                 messageStyle);
                 var titleStyle = _U.replace([["bold"
                                              ,true]],
                 messageStyle);
                 var messageBox = A3($Graphics$Element.container,
                 (_v91._0 / 2 | 0) - 10,
                 _v91._1 - 90,
                 $Graphics$Element.bottomLeft)($Graphics$Element.flow($Graphics$Element.up)(styleMap(messageStyle)(A2($List.take,
                 40,
                 state.messages))));
                 var helpText = $Graphics$Element.flow($Graphics$Element.down)(A2($List.append,
                 A2(styleMap,
                 titleStyle,
                 _L.fromArray(["Available commands:"])),
                 A2(styleMap,
                 messageStyle,
                 _L.fromArray(["    setName:Name -- Sets own name (may only be done once)"
                              ,"    connect:ID -- attempts to connect to an ID"]))));
                 var statusText = $Graphics$Element.flow($Graphics$Element.down)($List.concat(_L.fromArray([A2(styleMap,
                                                                                                           titleStyle,
                                                                                                           _L.fromArray(["You are:"]))
                                                                                                           ,A2(styleMap,
                                                                                                           messageStyle,
                                                                                                           _L.fromArray([selfText]))])));
                 var sysMessageText = styleMap(messageStyle)(A2($List.map,
                 $String.append("    "),
                 state.sysMessages));
                 var systemText = $Graphics$Element.flow($Graphics$Element.down)($List.concat(_L.fromArray([A2(styleMap,
                                                                                                           titleStyle,
                                                                                                           _L.fromArray(["System Messages:"]))
                                                                                                           ,sysMessageText])));
                 var textBox = A2($Html.toElement,
                 (_v91._0 / 2 | 0) - 10,
                 50)(A2($Html$Lazy.lazy,
                 function (x) {
                    return A2($Html.input,
                    _L.fromArray([$Html$Attributes.id("inputField")
                                 ,$Html$Attributes.placeholder("Input messages here")
                                 ,$Html$Attributes.autofocus(true)
                                 ,$Html$Attributes.value(x)
                                 ,$Html$Attributes.name("inputField")
                                 ,A3($Html$Events.on,
                                 "input",
                                 $Html$Events.targetValue,
                                 function ($) {
                                    return $Signal.send(boxChannel)(function (x) {
                                 ...
                                 function (x) {
                                    return _U.eq(x,
                                    13) ? $Result.Ok({ctor: "_Tuple0"}) : $Result.Err("Nah");
                                 }))($Basics.always(A2($Signal.send,
                                 fromElmChannel,
                                 A3(parseInput,
                                 state.textBox.string,
                                 state,
                                 _v91._0 * _v91._1 * $String.length(state.textBox.string)))))]),
                    _L.fromArray([]));
                 },
                 state.textBox.string));
                 var boxesOfText = A2($Graphics$Element.flow,
                 $Graphics$Element.down,
                 _L.fromArray([messageBox
                              ,A2($Graphics$Element.spacer,
                              (_v91._0 / 2 | 0) - 10,
                              10)
                              ,textBox]));
                 var defaultStyle = $Graphics$Input$Field.defaultStyle;
                 var outline = defaultStyle.outline;
                 return A2($Graphics$Element.flow,
                 $Graphics$Element.right,
                 _L.fromArray([boxesOfText
                              ,A2($Graphics$Element.spacer,
                              20,
                              _v91._1 - 20)
                              ...
                              _L.fromArray([A3($Graphics$Element.container,
                                           (_v91._0 / 2 | 0) - 10,
                                           30,
                                           $Graphics$Element.middle)($Text.centered($Text.style(headerStyle)($Text.fromString("Known Connections"))))
                                           ,A2(visualizeWorld,
                                           {ctor: "_Tuple2"
                                           ,_0: (_v91._0 / 2 | 0) - 10
                                           ,_1: _v91._1 / 2 | 0},
                                           ...
                                           (_v91._0 / 2 | 0) - 10,
                                           _v91._1 / 4 | 0,
                                           $Graphics$Element.topLeft)(systemText)]))]));
              }();}
         _U.badCase($moduleName,
         "between lines 498 and 582");
      }();
   });
   var BoxUpdate = function (a) {
      return {ctor: "BoxUpdate"
             ,_0: a};
   };
   var Cmd = function (a) {
      return {ctor: "Cmd",_0: a};
   };
   var Enter = function (a) {
      return {ctor: "Enter",_0: a};
   };
   var sigState = function () {
      var eventSig = $Signal.mergeMany(_L.fromArray([A2($Signal.map,
                                                    Cmd,
                                                    fromJS)
                                                    ,A2($Signal.map,
                                                    BoxUpdate,
                                                    $Signal.subscribe(boxChannel))
                                                    ,$Signal.map(Enter)($Signal.map(function (_v101) {
                                                       return function () {
                                                          switch (_v101.ctor)
                                                          {case "_Tuple2":
   ...
   var fromElm = _P.portOut("fromElm",
   _P.outgoingSignal(function (v) {
      return v;
   }),
   $Signal.mergeMany(_L.fromArray([$Signal.subscribe(fromElmChannel)
                                  ,A2($Signal.dropIf,
                                  $String.startsWith("noOp"),
                                  "noOp")($Signal.dropRepeats(A2($Signal.map,
                                  forward,
                                  sigState)))
                                  ,A2($Signal.dropIf,
                                  $String.startsWith("noOp"),
                                  "noOp")($Signal.map(timeUpdate)($Signal.sampleOn($Time.every($Time.second))(A3($Signal.map2,
                                  F2(function (v0,v1) {
                                     return {ctor: "_Tuple2"
                                            ,_0: v0
                                            ,_1: v1};
...
Elm.World.make = function (_elm) {
   ...
   $Result = Elm.Result.make(_elm),
   $String = Elm.String.make(_elm);
   var connIntID = function (conn) {
      return function () {
         var _v0 = $String.toInt(conn.id);
         switch (_v0.ctor)
         {case "Err": return -1;
      ...
      return function () {
         ...
         {case "_Tuple2":
            return function () {
                 switch (_v3.ctor)
                 {case "_Tuple2":
                    return _U.cmp(connIntID(_v3._0),
                      connIntID(_v4._0)) < 0 ? {ctor: "_Tuple2"
                                               ,_0: _v3._0
                                               ,_1: _v3._1} : {ctor: "_Tuple2"
                                                              ,_0: _v4._0
                                                              ,_1: _v4._1};}
   ...
   var getConnections = F2(function (conn,
   edges) {
      return function () {
         switch (edges.ctor)
         {case "::":
            switch (edges._0.ctor)
              {case "_Tuple2":
                 return _U.eq(conn.id,
                   edges._0._0.id) ? A2($List._op["::"],
                   edges._0._1,
                   A2(getConnections,
                   conn,
                   edges._1)) : _U.eq(conn.id,
                   edges._0._1.id) ? A2($List._op["::"],
                   edges._0._0,
                   A2(getConnections,
                   conn,
                   edges._1)) : A2(getConnections,
                   conn,
                   edges._1);}
              break;
            case "[]":
   ...
   var propagatePath = F2(function (_v16,
   edges) {
      return function () {
         switch (_v16.ctor)
         {case "_Tuple2":
            return function () {
                 var adjacents = A2(getConnections,
                 _v16._0,
                 edges);
                 var notVisited = A2($List.filter,
                 function (x) {
                    return $Basics.not(A2($List.member,
                    x,
                    _v16._1));
   ...
   var propagatePaths = F2(function (paths,
   edges) {
      return function () {
         var steppedPaths = A2($List.map,
         function (x) {
            return A2(propagatePath,
            x,
            edges);
         },
         paths);
         var accumPaths = A3($List.foldl,
         F2(function (_v20,_v21) {
            return function () {
               switch (_v21.ctor)
               {case "_Tuple2":
                  return function () {
         ...
         ,_1: _L.fromArray([])},
         steppedPaths);
         return _U.eq($Basics.fst(accumPaths),
         _L.fromArray([])) ? $Basics.snd(accumPaths) : A2($List.append,
         A2(propagatePaths,
         $Basics.fst(accumPaths),
         edges),
         $Basics.snd(accumPaths));
      }();
   });
         ...
         {case "::":
            switch (list._1.ctor)
              ...
              {case "_Tuple2":
                 switch (list._1.ctor)
                   {case "::":
                      switch (list._1._0.ctor)
                        {case "_Tuple2":
                           return _U.eq(list._0._0.id,
                             list._1._0._0.id) ? _U.cmp(list._0._1,
                             list._1._0._1) < 0 ? A2($List._op["::"],
                             {ctor: "_Tuple2"
                             ,_0: list._0._0
                             ,_1: list._0._1},
                             dropDuplicates(list._1._1)) : A2($List._op["::"],
                             {ctor: "_Tuple2"
                             ,_0: list._1._0._0
                             ,_1: list._1._0._1},
                             dropDuplicates(list._1._1)) : A2($List._op["::"],
            ...
            return _L.fromArray([]);}
         _U.badCase($moduleName,
         "between lines 154 and 160");
      }();
   };
   var generateDistances = F2(function (self,
   edges) {
      return function () {
         var allpaths = A2(propagatePaths,
         _L.fromArray([{ctor: "_Tuple2"
                       ,_0: self
                       ,_1: _L.fromArray([self])}]),
         edges);
         var pathswithlengths = A2($List.map,
         function (_v37) {
            return function () {
               switch (_v37.ctor)
               {case "_Tuple2":
                  return {ctor: "_Tuple2"
                         ,_0: _v37._0
                         ,_1: $List.length(_v37._1)};}
               _U.badCase($moduleName,
               "on line 148, column 49 to 65");
            }();
         },
         allpaths);
         return dropDuplicates(pathswithlengths);
      }();
   });
   var updateName = F2(function (conn,
   world) {
      return _U.eq(conn.name,
      "unassigned") ? world : function () {
         var updatenode = F2(function (x,
         y) {
            return _U.eq(y.id,
            x.id) ? _U.replace([["name"
                                ,x.name]],
            y) : y;
         });
                           ...
                           ,["edges"
                            ...
                            function (_v41) {
                               return function () {
                                  ...
                                  {case "_Tuple2":
                                     return {ctor: "_Tuple2"
                                            ,_0: A2(updatenode,conn,_v41._0)
                                            ,_1: A2(updatenode,
                                            conn,
                                            _v41._1)};}
                                  _U.badCase($moduleName,
                                  "on line 117, column 26 to 62");
                               }();
                            },
                            world.edges)]],
         world);
   ...
   var remNode = F2(function (c,
   world) {
      return function () {
         var newEdges = A2($List.filter,
         function (_v45) {
            return function () {
               switch (_v45.ctor)
               {case "_Tuple2":
                  return !_U.eq(_v45._0.id,
                    c) && !_U.eq(_v45._1.id,c);}
               _U.badCase($moduleName,
               "on line 102, column 57 to 79");
            }();
         },
         world.edges);
         var newNodes = A2($List.filter,
         function (x) {
            return !_U.eq(x.id,c);
         },
         world.nodes);
   ...
   var setName = F2(function (conn,
   world) {
      return function () {
         var upConn = F2(function ($new,
         old) {
            return _U.eq(old.id,
            $new.id) ? $new : old;
         });
         var upEdge = F2(function ($new,
         _v49) {
            return function () {
               switch (_v49.ctor)
               {case "_Tuple2":
                  return {ctor: "_Tuple2"
                         ,_0: A2(upConn,$new,_v49._0)
                         ,_1: A2(upConn,$new,_v49._1)};}
               _U.badCase($moduleName,
               "between lines 90 and 91");
            }();
         });
         var newEdges = A2($List.map,
         upEdge(conn),
         world.edges);
         var newNodes = A2($List.map,
         upConn(conn),
         world.nodes);
         return _U.replace([["nodes"
                            ,newNodes]
   ...
   var addEdge = F2(function (_v53,
   world) {
      return function () {
         switch (_v53.ctor)
         {case "_Tuple2":
            return function () {
                 var worldNodeIDs = A2($List.map,
                 function (x) {
                    return x.id;
                 },
                 world.nodes);
                 var worldEdgeIDs = A2($List.map,
                 function (_v57) {
                    return function () {
                       switch (_v57.ctor)
                       {case "_Tuple2":
                          return {ctor: "_Tuple2"
                                 ...
                                 ,_1: _v57._1.id};}
                       _U.badCase($moduleName,
                       "on line 69, column 45 to 54");
                    }();
                 },
                 world.edges);
                 return A2($List.member,
                 _v53._0.id,
                 worldNodeIDs) && A2($List.member,
                 _v53._1.id,
                 worldNodeIDs) ? A2($List.member,
                 {ctor: "_Tuple2"
                 ,_0: _v53._0.id
                 ,_1: _v53._1.id},
                 worldEdgeIDs) || A2($List.member,
                 {ctor: "_Tuple2"
                 ,_0: _v53._1.id
                 ,_1: _v53._0.id},
                 worldEdgeIDs) ? world : _U.replace([["edges"
                                                     ,A2($List._op["::"],
                                                     {ctor: "_Tuple2"
                                                     ,_0: _v53._0
                                                     ,_1: _v53._1},
                                                     world.edges)]],
                 world) : A2($List.member,
                 _v53._0.id,
                 worldNodeIDs) ? _U.replace([["nodes"
                                             ,A2($List._op["::"],
                                             _v53._1,
                                             world.nodes)]
                                            ,["edges"
   ...
   var fromJust = function (_v61) {
      return function () {
         ...
         _U.badCase($moduleName,
         "on line 61, column 21 to 22");
      }();
   };
   var getConnection = function (state) {
      return function () {
         var allconns = A2($List.map,
         function (x) {
            return {ctor: "_Tuple2"
                   ,_0: x
                   ,_1: $List.length(A2(getConnections,
                   x,
                   state.picture.edges))};
         },
         state.picture.nodes);
         var loners = A2($List.filter,
         function (_v64) {
            return function () {
               switch (_v64.ctor)
               {case "_Tuple2":
                  return _U.eq(_v64._1,1);}
               _U.badCase($moduleName,
               "on line 218, column 41 to 47");
            }();
         },
         allconns);
         var minID = A3($List.foldl,
         pickLower,
         {ctor: "_Tuple2"
         ,_0: fromJust(state.self)
         ,_1: 0},
         loners);
         var numpeople = $List.length(state.picture.nodes);
         var numconns = $List.length(state.connections);
         return !_U.eq($Basics.fst(minID),
         fromJust(state.self)) ? $Maybe.Nothing : function () {
            var alldistances = A2(generateDistances,
            fromJust(state.self),
            state.picture.edges);
            var farthestdist = $List.maximum(A2($List.map,
            $Basics.snd,
            alldistances));
            var farthests = A2($List.filter,
            function (_v68) {
               return function () {
                  switch (_v68.ctor)
                  {case "_Tuple2":
                     return _U.cmp(_v68._1,
                       farthestdist) > -1;}
                  _U.badCase($moduleName,
                  "on line 228, column 41 to 58");
               }();
            },
            alldistances);
            var smallID = A3($List.foldl,
            pickLower,
            {ctor: "_Tuple2"
            ,_0: {_: {},id: "101",name: ""}
            ,_1: 0},
            farthests);
            return $Maybe.Just($Basics.fst(smallID));
         }();
      }();
   };
   var checkScale = F2(function (state,
   conn) {
      return function () {
         switch (conn.ctor)
         {case "Just":
            return _U.cmp($List.length(state.connections),
              $Basics.round($Basics.logBase(2)($Basics.toFloat($List.length(state.picture.nodes))))) > -1 ? $Maybe.Nothing : function () {
                 var alldistances = A2(generateDistances,
                 fromJust(state.self),
                 state.picture.edges);
                 var farthestdist = $List.maximum(A2($List.map,
                 ...
                 function (_v74) {
                    return function () {
                       switch (_v74.ctor)
                       {case "_Tuple2":
                          return _U.cmp(_v74._1,
                            farthestdist) > -1;}
                       _U.badCase($moduleName,
                       "on line 265, column 43 to 60");
                    }();
                 },
                 alldistances);
                 var smallID = A3($List.foldl,
            ...
            return $Maybe.Nothing;}
         _U.badCase($moduleName,
         "between lines 252 and 271");
      }();
   });
   var manyConnections = function (state) {
      return function () {
         var allconns = A2($List.map,
         function (x) {
            return $List.length(A2(getConnections,
            x,
            state.picture.edges));
         },
         state.picture.nodes);
         var minall = $List.minimum(allconns);
         var numconns = $List.length(state.connections);
         return _U.cmp(numconns,
         minall) > 0 ? $Maybe.Nothing : checkScale(state)(getConnection(state));
      }();
   };
   var nextConnection = function (state) {
      return function () {
         var numnodes = $List.length(state.picture.nodes);
         var numconns = $List.length(state.connections);
         return _U.cmp(numnodes,
         2) < 1 ? $Maybe.Nothing : _U.cmp(numconns,
         1) < 1 && _U.cmp(numnodes,
         2) > 0 ? getConnection(state) : manyConnections(state);
      }();
   };
   var initState = {_: {}
                   ,connecting: false
                   ...
                   ,queue: _L.fromArray([])
                   ,self: $Maybe.Nothing
                   ,sysMessages: _L.fromArray([])
                   ,textBox: $Graphics$Input$Field.noContent};
   ...
   _elm.World.values = {_op: _op
                       ...
                       ,generateDistances: generateDistances
                       ,dropDuplicates: dropDuplicates
                       ,propagatePaths: propagatePaths
                       ,propagatePath: propagatePath
                       ,getConnections: getConnections
                       ,connIntID: connIntID
                       ,pickLower: pickLower
                       ,getConnection: getConnection
                       ,manyConnections: manyConnections
